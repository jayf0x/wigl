...
const LocalCodeWidget = () => {
  ...
  const [sidebarOpen, setSidebarOpen] = useStorage<boolean>(STORAGE_KEYS.sidebarOpen, true);
  ...
  return (
    <Widget w={10} h={9} col={0} row={0}>
      <WidgetHeader className="gap-2 py-1.5">
        <button
          type="button"
          data-no-drag
        ...
        <span
          ...
          className={cn(
            ...
            baseUrl ? "bg-primary/70" : "animate-pulse bg-muted-foreground/40",
          )}
        />
      </WidgetHeader>
